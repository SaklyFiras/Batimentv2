			...
			<div className="flex flex-col md:flex-row items-center">
				<div className="md:w-1/2 ">
					...
					<p className=" md:px-5 pt-4 font-light indent-2 ">
						La moquette de pierre, aussi appelée moquette de marbre ou tapis de
						pierre, est un revêtement de sol qui convient aussi bien en
						intérieur qu&apos;en extérieur, pour les particuliers comme les
						professionnels, Propriétaires de restaurant, hoteliers, gérants de
						camping, propriétaires de concessions automobiles, piscinistes...
						vous pouvez opter pour un revêtement de sol professionnel en marbre
						résiné afin d&apos;habiller vos locaux. Nous accompagnons les
						professionnels pour réaliser un projet de A à Z afin d&apos;habiller un
						espace intérieur ou extérieur. 
					</p>
					<Link
						href={"/entreprise/technique"}
						className=" text-white hover:text-white border mx-5 border-gray-800 hover:bg-gray-900 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 "
					>
						Learn more
					</Link>
				</div>
